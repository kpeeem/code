define('MdealsSentence', function (auth) {
        console.info('dealsSentenceModule-LOADED===============================================');
        //#Models##########################################################
        RES.Models.dealsSentenceModel = Backbone.Model.extend({
            url: "/api/auth/",
            initialize: function() {
        ...
        //#View###########################################################
        //authView
        RES.Views.dealsSentenceView = Backbone.View.extend({
            el: "#insert",
            events: {
