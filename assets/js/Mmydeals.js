define('Mmydeals', function (auth) {
        console.info('dealsListModule-LOADED===============================================');
        //#Models##########################################################
        RES.Models.mydealsModel = Backbone.Model.extend({
            url: "/api/auth/",
            initialize: function() {
                console.info("Model mydeals init");
        ...
        //#View###########################################################
        //authView
        RES.Views.mydealsView = Backbone.View.extend({
            el: "#insert",
            events: {
        ...
        console.info('MydealsModule-LOADED===============================================');
    return RES
